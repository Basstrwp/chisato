...
cfonts.say('Whatsapp Bot By Chisato',{
font: 'console',
gradient: ['red','magenta'],
align: 'center'
})
...
browser: ["Nishikigi Chisato", "Safari", "3.0"],
auth: state
})
