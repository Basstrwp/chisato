...
case 'kqqhbw': case 'shhsbs': case '?isoskis': {
  let menu = `
╔════════
╠══ *OWNER MENU*
╠ ${prefix}bc
...
╚════════
  `
  let but = [
  {urlButton: {displayText: 'Source Code ♨️',url: 'https://beacons.ai/chisato'}}, 
  {urlButton: {displayText: 'Website 🔗',url: 'https://beacons.ai/chisato'}}, 
...
case 'donasi': case 'sewa': case 'sewabot': {
  let donasi = `Chat Owner Jika Minat
...
case 'sc': case 'sourcecode': case 'script': {
  m.reply('*Script Berasal Dari :* https://beacons.ai/chisato')
  }
  break
case 'owner': {
...
case 'mc':
m.reply('Halo Chisato Disini Ada Yang Bisa Di Bantu?\n\n Ketik .sticker ( Untuk Membuat Sticker )\n\n Ketik .ytmp4 ( Untuk Mendownload Video Dari Youtube )\n\n Ketik .ytmp3 ( Untuk Mendownload Music Dari Youtube )\n\n Ketik .play [ Sertakan Judul Lagu ] ( Untuk Memutar Music )\n\n Ketik .wallpaper ( Untuk Mencari Wallpaper HP/PC )\n\n Ketik .quotesanime ( Untuk Melihat Kata² Mutiara Yg Mungkin Akan Menyentuh Hati Anda )\n\n Ketik .tomp3 ( Untuk Merubah MP4 menjadi MP3 dengan mudah ) \n\n *BOT INI MASIH DALAM TAHAP UJI COBA BELUM 100% SEMPURNA JADI MOHON MAAF JIKA ADA FITURE YG ERROR/TIDAAK BERFUNGSI*\n\n\n\n Copyright By *Nishikigi Chisato*')
break
